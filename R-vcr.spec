...
Version  : 0.5.0
Release  : 21
URL      : https://cran.r-project.org/src/contrib/vcr_0.5.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vcr_0.5.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583294686
