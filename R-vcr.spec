...
Version  : 1.1.0
Release  : 45
URL      : https://cran.r-project.org/src/contrib/vcr_1.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vcr_1.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667581227
...
/usr/lib64/R/library/vcr/libs/vcr.so.avx2
/usr/lib64/R/library/vcr/libs/vcr.so.avx512
